...
$filename = 'ftp://solarad:4r4w2015@192.168.30.38'.$row["tblftpfile"];
   ...
   if($cnt>=9){
    foreach(array_values($parts) as $key => $value)
		...
		$sql = "INSERT INTO tblftpfiledata (RecNum, tblAreaID, slrDate, slrTime, AvgUv, MinUv, MaxUv, AvgTmpUv, MinTmpUv, MaxTmpUv, BattVolt, AvgSolRad, MinSolRad, MaxSolRad, AvgSunshine) 
													 	VALUES ('', '0005','".$slrDate."','".$slrTime."','".$slrAvgUv."','".$slrMinUv."','".$slrMaxUv."','".$slrAvgUvTmp."','".$slrMinUvTmp."','".$slrMaxUvTmp."','".$slrBatt."','".$slrAvgRad."','".$slrMinRad."','".$slrMaxRad."','".$slrAvgSunshine."')";
